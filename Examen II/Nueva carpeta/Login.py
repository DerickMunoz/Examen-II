...
class Login:
    ...
    def facial(self):
        ruta = "C:\\Users\\Dairm\\PycharmProjects\\ControladorReconocimientoFacial\\.venv\\Espejo\\Clases\\Empleados"  # Carpeta donde se encuentran las fotos de los empleados
